...
export class TerminsuranceComponent implements AfterViewInit, OnDestroy {
  ...
  videos: VideoItem[] = [
    { num: '01', topic: 'Calculate Term', dur: '1:06', cap: 'Hindi', title: '', desc: 'The right cover depends on your income, loans, family needs, and future expenses.', url: 'https://www.youtube.com/watch?v=BdxPLZCGaGs', videoId: 'BdxPLZCGaGs' },
    { num: '02', topic: 'Term Basics', dur: '1:35', cap: 'Hindi', title: '', desc: 'Introduction to the basics of key terms and concepts and build a clear foundation before exploring advanced topics.', url: 'https://www.youtube.com/watch?v=ojBwmDJ9MDo', videoId: 'ojBwmDJ9MDo' },
    { num: '03', topic: 'CSR', dur: '1:31', cap: 'Hindi', title: '', desc: 'Compare CSR with claim amount settlement, complaint volume, and solvency ratio before choosing an insurer.', url: 'https://www.youtube.com/watch?v=2JR_5GSJ4q4', videoId: '2JR_5GSJ4q4' }, 
