...
export class GuaranteedinvestmentplansComponent implements AfterViewInit, OnDestroy {
  ...
  videos: VideoItem[] = [
    ...
    { num: '03', topic: 'Guaranteed Plans', dur: '1:16', cap: 'Hindi', title: '', desc: 'How a 6.5% guaranteed return beats a 7.5% FD after tax in the 30% bracket. The maths most advisors skip.', url: 'https://www.youtube.com/watch?v=SlBCoVcUvYM', videoId: 'SlBCoVcUvYM' },
